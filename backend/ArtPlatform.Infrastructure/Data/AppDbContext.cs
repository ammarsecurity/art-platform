...
public class AppDbContext : DbContext
{
    ...
    private static void SeedData(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<SiteSettings>().HasData(
            new SiteSettings { Id = 1, Key = "site_name", Value = "مرتضى ثامر", Description = "اسم الموقع" },
            ...
            new SiteSettings { Id = 4, Key = "hero_title", Value = "استكشف مرتضى ثامر", Description = "عنوان البانر الرئيسي" },
