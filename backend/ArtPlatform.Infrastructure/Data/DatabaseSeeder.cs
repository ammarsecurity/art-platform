        ...
        if (!await context.Courses.AnyAsync())
        {
            context.Courses.AddRange(
                ...
                new Course
                {
                    ...
                    Description = "استكشف مرتضى ثامر التجريدي وتعلم كيف تعبّر عن مشاعرك وأفكارك من خلال الألوان والأشكال. الدورة تشمل: تاريخ الفن التجريدي، مختلف الأساليب والتقنيات، واستخدام الألوان الأكريليكية وتقنيات الطلاء المختلفة.",
